...
const About = (props) => {
    return (
        <div className="about-wrapper">
            ...
            ipsum, animi, iste impedit similique sint nesciunt asperiores! Culpa ipsum numquam suscipit adipisci voluptates,
            consequatur corporis beatae asperiores quod, aperiam quis repellat! Inventore adipisci, autem labore nostrum quia
            perspiciatis voluptatum repellat voluptatibus expedita ullam molestiae nihil odit magnam animi quas illo atque facilis
            nemo incidunt in? Reprehenderit nam praesentium modi doloribus eaque voluptates eveniet, vel, earum autem aliquam illo.
